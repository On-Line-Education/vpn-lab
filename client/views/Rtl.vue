                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-lg-0 mb-4">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <p class="mb-5">
                                        من الألوان والبطاقات والطباعة إلى
                                        العناصر المعقدة ، ستجد الوثائق الكاملة.
                                    </p>
                                    <a
            ...
            <div class="col-lg-5">
                <div class="card h-100 p-3">
                    ...
                    >
                        ...
                        <div
                            class="card-body position-relative z-index-1 p-3 h-100"
                        >
                            <div class="d-flex flex-column h-100">
                                <h5
                                    class="text-white font-weight-bolder mb-4 pt-2"
                                >
                                    العمل مع الصواريخ
                                </h5>
                                <p class="text-white mb-5">
                                    تكوين الثروة هو لعبة تطوري حديثة ذات حصيلة
                                    إيجابية. الأمر كله يتعلق بمن يغتنم الفرصة
        ...
        <div class="mt-4 row">
            <div class="col-lg-5 mb-lg-0 mb-4">
                <div class="card">
                    <div class="card-body p-3">
                        <div
                            class="py-3 mb-3 bg-gradient-dark border-radius-lg pe-1"
                        >
                            <div class="chart">
                                <canvas
                                    id="chart-bars"
                        ...
                        <p class="text-sm ms-2">
                            (
                            <span class="font-weight-bolder">+23%</span>) من
                            الأسبوع الماضي
                        </p>
                    ...
                    <div class="card-header pb-0">
                        ...
                        <p class="text-sm">
                            <i
                                ...
                                aria-hidden="true"
                            ></i>
                            <span class="font-weight-bold">4% أكثر</span> في عام
                            2021
                        </p>
                    </div>
                    <div class="card-body p-3">
                    ...
                    <div class="card-body p-3">
                        <div class="timeline timeline-one-side">
                            ...
                            <div class="timeline-block mb-3">
                                <span class="timeline-step">
                                    <i
                                        class="ni ni-cart text-info text-gradient"
                                    ></i>
                                </span>
                                <div class="timeline-content">
                                    <h6
                            ...
                            <div class="timeline-block">
                                <span class="timeline-step">
                                    <i
                                        class="ni ni-money-coins text-dark text-gradient"
                                    ></i>
                                </span>
                                <div class="timeline-content">
                                    <h6
